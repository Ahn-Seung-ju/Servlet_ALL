...
public class RegisterFrontController extends HttpServlet {
    ...
    private void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String urlcommamd = requestURL.substring(contextPath.length());
    	
    	System.out.println("requestURL: " + requestURL);
    	System.out.println("contextPath: " + contextPath);
    	System.out.println("commamd: " + urlcommamd);
    	/*
    		requestURL: /webServlet8_Member_Model2_MVC_Url/Register.do
			contextPath: /webServlet8_Member_Model2_MVC_Url
			commamd: /Register.do
    	 */
    	...
    	if(urlcommamd.equals("/Register.do")) {  //?cmd=register
    		//화면전달
    		viewpage = "/WEB-INF/Register/Register.jsp";    		
    	}else if(urlcommamd.equals("/Registeok.do")) { //?cmd=registeok
    		//로직처리
    		//추가적인 데이터
