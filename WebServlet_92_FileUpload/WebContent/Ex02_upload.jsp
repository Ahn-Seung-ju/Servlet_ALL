...
<%
	...
	MultipartRequest multi = new MultipartRequest(
		...
		uploadpath, //실 저장 경로(배포된 경로) >> realPath로 찾아낸 경로
		size,
		"UTF-8",
		new DefaultFileRenamePolicy() //파일에 중복(upload > a.txt > a.txt 다시 업로드 > a_1.txt);
		
	);//파일 업로 완료
	//여기까지 코드가 서버에 upload폴더에 파일이 저장
	///Users/ahmseungju/WEB(back)/.metadata/.plugins/org.eclipse.wst.server.core/tmp1/wtpwebapps/WebServlet_92_FileUpload/upload
	//자료실
	//2가지
	//1. 서버에 파일 업로드
	...
	//2. 작성자, 제목, 내용, 파일명, 파일 사이즈, DB insert 작업
	//2.1 작업 ...text.MultipartRequest 가져오기
